...
function setList(list) {
  ...
  for (let key in list) {
    table += '<tr><td>'+ formatDesc(list[key].desc) +'</td><td>'+ formatAmount(list[key].amount) +'</td><td>'+ formatValue(list[key].value) +'</td><td><button class="btn btn-primary" onclick="setUpdate('+key+');">Edit</button>' + ' ' + '<button class="btn btn-primary" onclick="deleteData('+key+');">Delete</button></td></tr>';
  }
  table += '</tbody>';
